...
<link rel="shortcut icon" href="${ctx}/resources/images/favicon.ico"
	type="image/x-icon" />
<script type="text/javascript" src="./js/SuperManager_Menuinfo.js"></script>
...
<script type="text/javascript">
        ...
        formData.append("issuper", $("#is_Super").val());
        ...
        var tableUrl = "${ctx}/QueueMenuinfo/superlist";
        table = $('#example1')
        .DataTable(
        {
    ...
    if(isSearch=="1"){
        ...
        $.ajax({
        type:'POST',
        url:'${ctx}/QueueMenuinfo/searchsuperupmenulist?menuLevel='+menuLevel,
        cache:false,
        async:false,
        dataType: 'json',
        success: function(data){
				...
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						<form class="form-horizontal" role="form" action="#" method="post"
							id="itemInfoForm">
    <input type="hidden" name="Area_Ls"
    id="Area_Ls" value="0">
