    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','#addDataBtn',function() {
                ...
                $.ajax({
                    url : "${ctx}/HospitalqueueRoleinfo/insert",
                    type : "post",
                    dataType : "json",
                    data : {
            ...
            $(document).on('click', '#updateDataBtn', function() {
                ...
                $.ajax({
                    url : "${ctx}/HospitalqueueRoleinfo/update",
                    type : "post",
                    dataType : "json",
                    data : {
			...
			$("#menuConfig").click(function(){
				...
				var params = "?roleLs="+roleLs+"&roleName="+roleName+"&permissionsType=menu";
				//参数中有中文，需要转码
				params = encodeURI (encodeURI(params));
				showFrameDialog(argTitle,"${ctx}/page/manage/roleinfo/HospitalRoleMenu.jsp"+params)
			});
        ...
        function loadTable() {
            ...
            var tableUrl = "${ctx}/HospitalqueueRoleinfo/list";
            table = $('#example1')
                    .DataTable(
                            {
                ...
                <div class="ibox-content">
                    ...
                    <div id="configTr" class="table_menu_tr_zd"
							...
							<div class="optionRow-right" style="padding-right: 10px">
								<button type="button"
									class="btn btn-primary btn-sm input_btn_btn list_btn  table_button_zd"
									id="caseConfig">项目权限</button>
								<button type="button"
									class="btn btn-primary btn-sm input_btn_btn list_btn  table_button_zd"
									id="menuConfig">菜单权限</button>
							</div>
					</div>
