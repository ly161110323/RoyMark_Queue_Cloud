...
<link rel="shortcut icon" href="${ctx}/resources/images/favicon.ico"
	...
	<%--ztree下拉框树相关js结束--%>
	<script type="text/javascript" src="./js/webaccount.js"></script>
<script type="text/javascript">
        ...
        $(document).ready(function() {
			...
			$("#accountConfig").click(function(){
				...
				var areaLs=$cBox.closest('tr').children().eq(10).text(); //增加参数areaLs
				var params = "?webAccountLs="+webAccountLs+"&webAccountName="+webAccountName+"&areaLs="+areaLs;
				var argTitle = "账号权限["+webAccountName+"]";
				//参数中有中文，需要转码
				params = encodeURI (encodeURI(params));
				showFrameDialog(argTitle,"${ctx}/page/manage/webaccount/QueueWebAccountRole.jsp"+params);
			});
        ...
        function loadTable() {
                    ...
                    .DataTable(
                            {
                                ...
                                "bLengthChange": false,
                                "aoColumns" : [
                                    {'mData': 'webaccountLs', 'sTitle': '<input type="checkbox" name="checklist" id="checkall" />',
										'sName': 'webaccountLs', 'sClass': 'center'},
                                    {'mData': 'webaccountLs', 'sTitle': '序号', 'sName': 'webaccountLs', 'sClass': 'center'},
                                    {'mData': 'webaccountName', 'sTitle': '账号名称', 'sName': 'webaccountName', 'sClass': 'center'},
                                    {'mData': 'webaccountLogin', 'sTitle': '登录账号', 'sName': 'webaccountLogin', 'sClass': 'center'},
                                    {'mData': 'webaccountPassword', 'sTitle': '登录密码', 'sName': 'webaccountPassword', 'sClass': 'center'},
                                    {'mData': 'areaName', 'sTitle': '所属大厅', 'sName': 'areaName', 'sClass': 'center'},
                                    {'mData': 'userInfoName', 'sTitle': '所属人员', 'sName': 'userInfoName', 'sClass': 'center'},
                                    {'mData': 'webaccountImage', 'sTitle': '头像', 'sName': 'webaccountImage', 'sClass': 'center'},
                                    {'mData': 'webaccountCode', 'sTitle': '账号编号', 'sName': 'webaccountCode', 'sClass': 'center'},
                                    {'mData': 'webaccountText', 'sTitle': 'webaccountText', 'sName': 'webaccountText', 'sClass': 'hidden webaccountText'},
                                    {'mData': 'areaLs', 'sTitle': 'areaLs', 'sName': 'areaLs', 'sClass': 'hidden areaLs'},
                                    {'mData': 'userinfoLs', 'sTitle': 'userInfoLs', 'sName': 'userinfoLs', 'sClass': 'hidden userinfoLs'}
                                    ],
            ...
            $('#example1 tbody').on('click', 'tr', function() {
                ...
                $("#Area_Name").val($(this).find("td:eq(5)").text());
                ...
                $("#Area_Ls").val($(this).find("td:eq(10)").text());
								...
								<tr>
									<td style="width: 25%;">
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text"
													style="width: 98%;" autocomplete="off"
													class="form-control m-b input_btn_input table_content_zd"
													readonly="readonly" name="Area_Name" id="Area_Name">
												<input type="hidden"
													   name="Area_Ls" id="Area_Ls">
											</div>
										</div>
									</td>
									<td style="width: 25%;">
										<div class="form-group">
											<label style="width: 40%;" class="col-sm-3 control-label input_lable_hm table_label_zd">所属人员：</label>
											<div class="col-sm-8">
												<input type="text" autocomplete="off" spellcheck="false"  class="form-control table_content_zd"  name="userInfoName" id="userInfoName" readonly="readonly">
											</div>
										</div>
									</td>
									<td style="width: 25%;">
