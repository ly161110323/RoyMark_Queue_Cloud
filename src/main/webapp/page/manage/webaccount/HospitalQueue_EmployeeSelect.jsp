    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#selectBtn', function() {
                if(dataId == ""){
                	layer.alert("请勾选一条人员信息");
                	return;
                }
                var $cBox = $("[name=choice]:checked");
                if($cBox.length>1){
                	layer.alert("只能选择一条人员信息！");
                	return;
                }
                //返回值给父页面
                parent.$('#Employee_Name').val(employeeName);
                parent.$('#Employee_Ls').val(employeeLs);
        ...
        function loadTable() {
            ...
            var tableUrl = "${ctx}/HospitalqueueEmployee/singletablelist";
            table = $('#example1')
                    .DataTable(
                            {
                                ...
                                "columnDefs" : [
                                                    {
                                                        ...
                                                        render : function(data, type, row, meta) {
                                                            var html = "<input type='checkbox' value="+row.employeeLs+" class='lsCheck' name='choice' />";
                                                            return html;
                                                        }
                                                    }
                                    ]
            ...
            $('#example1 tbody').on('click', 'tr', function() {
                ...
                employeeLs = $(this).find("td:eq(0) input[type='checkbox']").val();
                employeeName = $(this).find("td:eq(4)").text();
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                            ...
                            <tr class="table_menu_tr_zd">
                                <td class="table_menu_tr_td_left_zd">
                                    <label style="width: 10%;"
                                                     class="col-sm-3 control-label input_lable_hm table_label_zd">姓名：</label>
                                    <input type="text" autocomplete="off"
                                           class="form-control input_btn_input table_content_zd"
                                           id="Employee_Name" style="width: 15%;">
                                    <button type="button"
                                            class="table_button_zd btn btn-sm search_rm_button_index"
                                            id="index_select">查询</button>
                                </td>
                    ...
                    <table id="example1" class="table table-bordered" style="table-layout:fixed"></table>
                </div>
            </div>
        </div>
    </div>
